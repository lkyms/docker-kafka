 ...
 */
package course.kafka.example.avro.v1;
...
public class User extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 4165099097696114097L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"User\",\"namespace\":\"course.kafka.example.avro.v1\",\"fields\":[{\"name\":\"name\",\"type\":\"string\"},{\"name\":\"favorite_number\",\"type\":[\"int\",\"null\"]},{\"name\":\"favorite_color\",\"type\":[\"string\",\"null\"]},{\"name\":\"user_id\",\"type\":\"long\"}]}");
   ...
   */
  public User(CharSequence name, Integer favorite_number, CharSequence favorite_color, Long user_id) {
    this.name = name;
  ...
  public void put(int field$, Object value$) {
    ...
    case 3: user_id = (Long)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<User>
    ...
    public User build() {
      try {
        ...
        record.user_id = fieldSetFlags()[3] ? this.user_id : (Long) defaultValue(fields()[3]);
        return record;
